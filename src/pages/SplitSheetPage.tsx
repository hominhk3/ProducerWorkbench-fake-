          ...
          <div className="space-y-3">
            {milestoneSplits.map((split, index) => {
              ...
              return (
                <div
                  key={index}
                  className="flex items-center justify-between bg-dark-surface p-3 rounded-md"
                >
        ...
        <section className="bg-dark-surface p-6 rounded-2xl border border-border-color mb-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div className="bg-dark-bg p-4 rounded-lg">
              <p className="text-sm text-text-secondary flex items-center justify-center space-x-2">
                <FiPieChart />
